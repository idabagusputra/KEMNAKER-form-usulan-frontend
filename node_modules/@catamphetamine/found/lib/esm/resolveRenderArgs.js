...
function _resolveRenderArgs() {
  _resolveRenderArgs = _wrapAsyncGenerator(function* (router, {
    ...
    try {
      ...
      try {
        for (var _iterator = _asyncIterator(resolver.resolveElements(augmentedMatch)), _step; _iteratorAbruptCompletion = !(_step = yield _awaitAsyncGenerator(_iterator.next())).done; _iteratorAbruptCompletion = false) {

  ...
  class BaseRouter extends React.Component {
    ...
    async resolveMatch() {
      ...
      try {
        ...
        try {
          for (var _iterator = _asyncIterator(resolveRenderArgs(this.router, this.props)), _step; _iteratorAbruptCompletion = !(_step = await _iterator.next()).done; _iteratorAbruptCompletion = false) {

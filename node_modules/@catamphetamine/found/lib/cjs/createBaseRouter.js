...
function createBaseRouter({
  ...
  class BaseRouter extends _react.default.Component {
    ...
    componentDidMount() {
      ...
      if (process.env.NODE_ENV !== "production" && typeof window !== 'undefined') {
        ...
        if (window.__FOUND_HOT_RELOAD__) {
          process.env.NODE_ENV !== "production" ? (0, _tinyWarning.default)(!window.__FOUND_REPLACE_ROUTE_CONFIG__, 'Replacing existing hot reloading hook. Do not render more than one router instance when using hot reloading.') : void 0;
    ...
    static getDerivedStateFromProps({
      ...
      if (match !== state.match || resolver !== state.resolver || !(0, _dequal.dequal)(matchContext, state.matchContext)) {
        return {
          match,
          resolver,
          matchContext,
    ...
    async resolveMatch() {
      ...
      try {
        ...
        try {
          for (var _iterator = _asyncIterator((0, _resolveRenderArgs.default)(this.router, this.props)), _step; _iteratorAbruptCompletion = !(_step = await _iterator.next()).done; _iteratorAbruptCompletion = false) {
    ...
    render() {
      ...
      return /*#__PURE__*/(0, _jsxRuntime.jsx)(_StaticContainer.default, {
        ...
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_RouterContext.default.Provider, {
          value: routerContext,
          children: element
        })
      });

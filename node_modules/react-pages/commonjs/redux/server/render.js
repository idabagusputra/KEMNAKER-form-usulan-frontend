...
var _createRouterElement = _interopRequireDefault(require("../../router/server/createRouterElement.js"));
...
function _renderOnServer() {
  _renderOnServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var store, codeSplit, getDefaultMeta, time, preloadTimer, renderArgs, _renderArgs, routes, elements, meta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          store = _ref.store, codeSplit = _ref.codeSplit, getDefaultMeta = _ref.getDefaultMeta;
          ...
          _context.prev = 3;
          _context.next = 6;
          return (0, _index.matchRoutes)(store);
        case 6:
        ...
        case 9:
          ...
          if (!(_context.t0 instanceof _index.RedirectException)) {
            _context.next = 13;
            break;
          }
        ...
        case 14:
          ...
          meta = _objectSpread(_objectSpread({}, getDefaultMeta()), meta);

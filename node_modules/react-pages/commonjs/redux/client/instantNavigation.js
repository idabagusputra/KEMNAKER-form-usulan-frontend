...
exports.addInstantBack = addInstantBack;
exports.canGoBackInstantly = canGoBackInstantly;
exports.canGoForwardInstantly = canGoForwardInstantly;
exports.isInstantBackAbleNavigation = isInstantBackAbleNavigation;
exports.isInstantTransition = isInstantTransition;
exports.markImmediateNavigationAsInstantBack = markImmediateNavigationAsInstantBack;
exports.resetInstantNavigationChain = resetInstantNavigationChain;
exports.setInstantNavigationFlag = setInstantNavigationFlag;
exports.updateInstantNavigationChainIndex = updateInstantNavigationChainIndex;
exports.wasInstantNavigation = wasInstantNavigation;
var instantNavigationChain = [];
var instantNavigationChainIndex = -1;
 ...
 */
function addInstantBack(nextLocation, previousLocation, nextLocationRouteComponents, previousLocationRouteComponents) {
  var chain = instantNavigationChain;
  ...
  if (chain.length > 0) {
    var previousLocationIndex = indexOfByKey(chain, getLocationKey(previousLocation));
  ...
  var sameRoutesIndex = findSameRoutesLocationIndex(chain, nextLocationRouteComponents);
 ...
 */
function isInstantTransition(fromLocation, toLocation) {
  return indexOfByKey(instantNavigationChain, getLocationKey(fromLocation)) >= 0 && indexOfByKey(instantNavigationChain, getLocationKey(toLocation)) >= 0;
}

/**
 * Clears any "instant back" history.
 */
function resetInstantNavigationChain() {
 ...
 */
function updateInstantNavigationChainIndex(location) {
  var i = 0;
 ...
 */
var getLocationKey = function getLocationKey(location) {
  return location.key;
};
 ...
 * @return
 */
function markImmediateNavigationAsInstantBack(instantBack) {
  ...
  if (instantBack) {
    ...
    setTimeout(function () {
      return window._ReactPages_Page_IsInstantBackNavigation = false;
    }, 0);
  }
}
function canGoBackInstantly() {
  return instantNavigationChainIndex > 0;
}
function canGoForwardInstantly() {
  return instantNavigationChainIndex < instantNavigationChain.length - 1;
}
//# sourceMappingURL=instantNavigation.js.map
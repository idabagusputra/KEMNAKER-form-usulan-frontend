...
describe("load", function () {
  ...
  it("should return preloader results", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var preload_1, preload_2, preload_3, preload_4, preload_5, promise, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          preload_1 = function preload_1() {
            return Promise.resolve({
              a: 1
            });
          };
          preload_2 = function preload_2() {
            return Promise.resolve({
              b: 2
            });
          };
          preload_3 = function preload_3() {
            return Promise.resolve();
          };
          preload_4 = function preload_4() {
            return Promise.resolve();
          };
          preload_5 = function preload_5() {
            return Promise.resolve({
              e: 5
            });
          };
          promise = (0, _chain.promisify)([{
            parallel: [preload_1, preload_2]
          }, {
            parallel: [preload_3, preload_4]
          }, preload_5], {

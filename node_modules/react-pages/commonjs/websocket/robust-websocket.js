...
var _CustomEvent = _interopRequireDefault(require("./CustomEvent"));
...
function RobustWebSocket(url, protocols, userOptions) {
  var realWs = {
    ...
    pendingReconnect,
    opts = Object.assign({}, RobustWebSocket.defaultOptions, typeof userOptions === 'function' ? {
      shouldReconnect: userOptions
    } : userOptions);

...
var _robustWebsocket = _interopRequireDefault(require("../../client/robust-websocket.js"));
...
function websocket(_ref) {
  ...
  var _websocket = new _robustWebsocket["default"]("".concat(secure ? 'wss' : 'ws', "://").concat(host, ":").concat(port), undefined, {

...
var _renderError2 = _interopRequireDefault(require("./renderError.js"));
...
function _respondWithPage() {
  _respondWithPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response, settings, options) {
    var _yield$renderPage, redirect, cookies, status, content, _iterator, _step, _cookie;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 2:
          _yield$renderPage = _context.sent;
          redirect = _yield$renderPage.redirect;
          cookies = _yield$renderPage.cookies;
          status = _yield$renderPage.status;
          content = _yield$renderPage.content;
          if (!redirect) {
            _context.next = 10;
            break;
          }
...
function _renderPage() {
  _renderPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(url, headers, settings, options) {
    var secure, proxy, assets, renderContent, html, stats, getInitialState, cookies, _yield$render, status, content, redirect, route, time, newCookies;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          secure = options.secure, proxy = options.proxy, assets = options.assets, renderContent = options.renderContent, html = options.html, stats = options.stats, getInitialState = options.getInitialState;
        ...
        case 4:
          ...
          newCookies = _yield$render.cookies;
          if (!redirect) {
            _context2.next = 13;
            break;
          }

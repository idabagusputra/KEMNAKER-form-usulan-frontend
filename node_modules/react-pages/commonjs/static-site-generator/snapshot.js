...
exports["default"] = snapshotWebsite;
...
function _snapshotWebsite() {
  _snapshotWebsite = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", snapshot(_objectSpread(_objectSpread({}, options), {}, {
...
function _snapshot() {
  _snapshot = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          snapshotProgress = new _progress["default"](' Snapshotting [:bar] :total :percent :etas', {
            complete: '=',
            incomplete: ' ',
            width: 50,
            total: pages.length
        ...
        case 6:
          ...
          _fsExtra["default"].moveSync(_path["default"].join(outputPath, 'react-pages-base/index.html'), _path["default"].join(outputPath, 'base.html'));
          _fsExtra["default"].removeSync(_path["default"].join(outputPath, 'react-pages-base'));
        case 8:
        case "end":
...
function _snapshotPages() {
  _snapshotPages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(host, port, pages, outputPath, transformContent, tick) {
    var _iterator, _step, page;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _fsExtra["default"].remove(outputPath);
        case 2:
...
function _snapshotPage() {
  _snapshotPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(host, port, page, outputPath, transformContent) {
    var url, targetStatusCode, _url, _yield$download, status, content;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 6;
          return (0, _download["default"])(_url);
        case 6:
          _yield$download = _context4.sent;
          status = _yield$download.status;
          content = _yield$download.content;
        ...
        case 11:
          _fsExtra["default"].outputFileSync(_path["default"].join(outputPath, url, '/index.html'), transformContent ? transformContent(content) : content);
        case 12:
        case "end":
...
function addReloadDataFlag(content) {
  ...
  return content.slice(0, headEndsAt) + '<script> window._ReactPages_Page_ReloadDataOnClientRender = true </script>' + content.slice(headEndsAt);
}
